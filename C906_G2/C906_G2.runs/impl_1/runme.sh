...
HD_PWD='E:/G2_C906/C906_G2/C906_G2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log c906_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source c906_top.tcl -notrace
